document.addEventListener('DOMContentLoaded', () => {
    ...
    function endGame() {
        ...
        if (percentage === 100) {
            finalMessage.textContent = "Wow! You're a Leopard Gecko Expert! 🏆";
        } else if (percentage >= 80) {
            finalMessage.textContent = "Great job! You know your geckos! 🦎";
        } else if (percentage >= 50) {
            finalMessage.textContent = "Good effort! Keep learning about these cute lizards! 📚";
        } else {
            finalMessage.textContent = "Nice try! Time to study more about geckos! 🧐";
        }
    }
});
